import{monthList, overlayLittleClose, overlayLittle, toDoDay, toDoInput, ol, btnAdd, database, rootRef} from './variables.js'
...
export function connectDatabase(){
    ...
    btnAdd.addEventListener('click', (e) => { 
        ...
        if(toDoDay.innerHTML){                        ///  check if the selected date
            ...
            getToDoList();
        } else {                                             /// if not selected date
            overlayLittle.style.display = 'block';
        }
    })


    overlayLittleClose.addEventListener("click", () => {
        overlayLittle.style.display = 'none';
    })
