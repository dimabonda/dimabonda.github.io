...
export function createCalendar(){
    ...
    ///////////////////////////////////////////////////////////////////////
    let prevForYear = function(){
        year.innerHTML = --curryear;
        removeCalendar();
        createCalendarForYear();
    }

    let nextForYear = function(){
        year.innerHTML = ++curryear;
        removeCalendar();
        createCalendarForYear();
    }

    let prevForMonth = function(){
        removeCalendar();
